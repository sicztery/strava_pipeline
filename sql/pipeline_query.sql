...
cast(try_cast(average_watts AS double) AS bigint) AS average_watts,
cast(try_cast(max_watts AS double) AS bigint) AS max_watts,
cast(try_cast(weighted_average_watts AS double) AS bigint) AS weighted_average_watts,
cast(try_cast(kilojoules AS double) AS bigint) AS kilojoules,
cast(try_cast(suffer_score AS double) AS bigint) AS suffer_score,
device_name,
gear_id,
